...
```
The F-test in the model summary is comparing the full model to the null model.  In this case the associated p-value is extremely small, implying that the full model is superior.  Similarly, the delta-AIC between the full model and the null model is 208.88; this difference is more than 100 times greater in magnitude than the difference of 2 which is generally considered to be large.
